...
get_header(); ?>
				...
				<div class="jumbotron__texts">
					...
					<ul class="jumborton__list">
						<li class="jumbotron__list-item">
							<span class="jumbotron__list-item-text">Relieve Sinus Headaches</span>
						</li>
						<li class="jumbotron__list-item">
							<span class="jumbotron__list-item-text">Alleviate Facial Pain and Pressure</span>
						</li>
						<li class="jumbotron__list-item">
	...
	<div class="container" id="anchor--1">
		<div class="content content-2">
			<div class="wrapper content-2__wrapper">
				...
				<div class="content-2__bottom">
					<div class="description description-btn description-btn--white">Check your eligibility today with our test:</div>
					<a href="#anchor--5" class="btn btn--content-2 anchor">take the test</a>
				</div>
			</div><!-- wrapper -->
		</div><!-- content -->
	</div><!-- container -->

	<div class="container" id="anchor--2">
	...
	<div class="container container--yellow">
		<div class="content content-4">
			<p class="description-btn description-btn--dark">Check your eligibility today with our test:</p>
			<a href="#anchor--5" class="btn btn--content-4 btn--white anchor">take the test</a>
		</div>
	</div>
	...
	<div class="container container--table container--white" id="anchor--5">
			...
			<div class="wrapper wrapper--table">
				...
				<div class="status-progress row">
					<div class="step-info">
						...
						<span class="step-i-value step-i-value-1"><span class="value">0</span>/20</span>
						<div class="progress-bar step">
							<span style="width: 0%;"></span>
						</div>
					</div>
					<div class="score-info">
						<span class="status-progress__title">Score</span>
						<span class="score-i-value score-i-value-2"><span class="value">0</span>/100</span>
						<div class="progress-bar score">
							<span style="width: 0%;"></span>
						</div>
					</div>
